                ...
                <div className="flex items-center">
                  <Link href="/">
                    <h1 className="text-2xl font-medium">
                      Burhanuddin <span className="text-teal-500">Marcha</span>
                    </h1>
                  </Link>
                </div>
              ...
              <Link
                ...
                className={`${
                  pathname === "/"
                    ...
                    : "border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-teal-500 block pl-3 pr-4 py-2 dark:hover:bg-gray-700 border-l-4 text-base fon font-medium dark:text-white"
                }`}
              >
                Home
              </Link>
