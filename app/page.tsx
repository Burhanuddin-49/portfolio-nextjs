    ...
    <div className="divide-y divide-gray-100 dark:divide-gray-700">
      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col items-center pt-8">
          <Image
            src={Me}
            alt="Picture of Burhanuddin Marcha"
          ...
          <p className="text-gray-500 dark:text-gray-300 text-center">
            Hey my name is Burhanuddin and I am a Full Stack Developer
          </p>
        ...
        <div className="prose max-w-none prose-lg pt-8 sm:pt-2 pb-7 dark:prose-invert xl:col-span-2">
          ...
          <p>
            ...
            adipisci, facere, quia totam unde laudantium nulla at aliquid fugiat
            est illo rerum inventore accusantium quaerat eaque officiis ex, sit
            neque.
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio
            accusamus aliquid adipisci iste! Accusantium, velit? Iste, numquam?
            Optio, similique sapiente blanditiis cupiditate iure voluptas sint
            veritatis nostrum recusandae mollitia consectetur!
          </p>
        </div>
      </div>
    </div>
